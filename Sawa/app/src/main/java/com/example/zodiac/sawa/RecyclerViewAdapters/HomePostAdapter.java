...
public class HomePostAdapter extends RecyclerView.Adapter<HomePostAdapter.UserViewHolder>
    ...
    ArrayList<PostResponseModel> postResponseModelsList = new ArrayList<PostResponseModel>();
    PostInterface service;
    private Context mContext;

    public HomePostAdapter(Context mContext,ArrayList<PostResponseModel> postResponseModelsList) {
    ...
    public int getItemCount() {
        return null!=postResponseModelsList?postResponseModelsList.size():0;
    }
